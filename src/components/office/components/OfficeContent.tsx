...
const defaultChairs: Chair[] = [
  ...
  { id: "chair-4", x: -55, y: 38, type: "back" },
  { id: "chair-5", x: 10, y: 38, type: "back" },
  { id: "chair-6", x: 75, y: 38, type: "back" },
  { id: "chair-7", x: 235, y: -42, type: "front" },
  { id: "chair-8", x: 300, y: -42, type: "front" },
  { id: "chair-9", x: 365, y: -42, type: "front" },
  { id: "chair-10", x: 235, y: 38, type: "back" },
  { id: "chair-11", x: 300, y: 38, type: "back" },
  { id: "chair-12", x: 365, y: 38, type: "back" },
  { id: "chair-01", x: -55, y: 78, type: "front" },
  { id: "chair-02", x: 10, y: 78, type: "front" },
  { id: "chair-03", x: 75, y: 78, type: "front" },
  { id: "chair-04", x: -55, y: 158, type: "back" },
  { id: "chair-05", x: 10, y: 158, type: "back" },
  { id: "chair-06", x: 75, y: 158, type: "back" },
  { id: "chair-07", x: 235, y: 78, type: "front" },
  { id: "chair-08", x: 300, y: 78, type: "front" },
  { id: "chair-09", x: 365, y: 78, type: "front" },
  { id: "chair-010", x: 235, y: 158, type: "back" },
  { id: "chair-011", x: 300, y: 158, type: "back" },
  { id: "chair-012", x: 365, y: 158, type: "back" },
];
