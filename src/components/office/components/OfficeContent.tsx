...
const defaultChairs: Chair[] = [
  ...
  { id: "chair-01", x: -55, y: 98, type: "front" },
  { id: "chair-02", x: 10, y: 98, type: "front" },
  { id: "chair-03", x: 75, y: 98, type: "front" },
  { id: "chair-04", x: -55, y: 178, type: "front" },
  { id: "chair-05", x: 10, y: 178, type: "front" },
  { id: "chair-06", x: 75, y: 178, type: "front" },
  { id: "chair-07", x: 235, y: 98, type: "front" },
  { id: "chair-08", x: 300, y: 98, type: "front" },
  { id: "chair-09", x: 365, y: 98, type: "front" },
  { id: "chair-010", x: 235, y: 178, type: "front" },
  { id: "chair-011", x: 300, y: 178, type: "front" },
  { id: "chair-012", x: 365, y: 178, type: "front" },
];
